...
import { getDevelopmentPlanById } from 'apiSdk/development-plans';
...
function DevelopmentPlanViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('development_plan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/development-plans/edit/${data?.id}`} passHref legacyBehavior>
              <Button
