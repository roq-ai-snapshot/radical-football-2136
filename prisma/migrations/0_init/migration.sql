...
-- AddForeignKey
ALTER TABLE "development_plan" ADD CONSTRAINT "development_plan_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
